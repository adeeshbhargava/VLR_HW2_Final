...
def get_fid(gen, dataset_name, dataset_resolution, z_dimension, batch_size, num_gen):
    ...
    #out = z.reshape(batch_size,3,dataset_resolution,dataset_resolution)
    
    gen_fn = lambda z : gen.sample_given_z(z,(batch_size,3,dataset_resolution,dataset_resolution))
